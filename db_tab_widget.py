...
from tab_widget_button import QTableWidgetButton
...
class QDatabaseTableWidget(QTableWidget):
    ...
    def _create_row(self, row_idx: int):
        try:
            ...
            QMessageBox.critical(self, "Невозможно выполнить запрос", "Заполните все колонки")
            return
        ...
        try:
            ...
            QMessageBox.critical(
                ...
                "Строки с данным идентификатор нет."
                "Пожалуйста, перепроверьте индентификатор",
            )
            return
    ...
    def _update_row(self, row_idx: int, row_id: int):
        ...
        try:
            ...
            QMessageBox.critical(
                ...
                "Пожалуйста, измените значение (значение) на корректные и повторите попытку",
            )
